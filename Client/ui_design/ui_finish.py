...
class StuffDetail(QDialog):
    ...
    def __init__(self):
        ...
        self.user_layout.addWidget(self.l_user_name, 1, 0, 1, 1)
        self.user_layout.addWidget(self.d_user_name, 1, 1, 1, 3)
        self.user_layout.addWidget(self.l_user_type, 2, 0, 1, 1)
        self.user_layout.addWidget(self.d_user_type, 2, 1, 1, 1)
        self.user_layout.addWidget(self.l_grade_class, 3, 0, 1, 1)
        self.user_layout.addWidget(self.d_grade, 3, 1, 1, 1)
        self.user_layout.addWidget(self.d_major, 3, 2, 1, 2)
        self.user_layout.addWidget(self.d_class, 3, 4, 1, 1)
        self.user_layout.addWidget(self.l_tel, 4, 0, 1, 1)
        self.user_layout.addWidget(self.d_tel, 4, 1, 1, 3)
        self.user_layout.addWidget(self.l_email, 5, 0, 1, 1)
        self.user_layout.addWidget(self.d_email, 5, 1, 1, 3)
        self.user_layout.addWidget(self.bt_close, 6, 3, 1, 1)
        self.user_layout.addWidget(self.bt_insert, 6, 2, 1, 1)
        self.user_layout.addWidget(self.bt_update, 6, 1, 1, 1)
        self.user_layout.addWidget(self.timestamp, 7, 0, 6, 6)
        self.user_layout.addWidget(self.hour_everyday, 7, 6, 6, 6)
...
class MyselfInfo(QWidget):
    ...
    def __init__(self):
        ...
        self.d_user_id.setEnabled(False)
        self.d_user_name = QLineEdit()
        self.d_user_name.setEnabled(False)
        self.d_major = QLineEdit()
        ...
        self.myself_lay.addWidget(self.l_user_name, 3, 2, 1, 1)
        self.myself_lay.addWidget(self.d_user_name, 3, 3, 1, 2)
        self.myself_lay.addWidget(self.l_user_type, 4, 2, 1, 1)
        self.myself_lay.addWidget(self.d_user_type, 4, 3, 1, 1)
        self.myself_lay.addWidget(self.l_grade_class, 5, 2, 1, 1)
        self.myself_lay.addWidget(self.d_grade, 5, 3, )
        self.myself_lay.addWidget(self.d_major, 5, 4, )
        self.myself_lay.addWidget(self.d_class, 5, 5, )
        self.myself_lay.addWidget(self.l_tel, 6, 2, 1, 1)
        self.myself_lay.addWidget(self.d_tel, 6, 3, 1, 3)
        self.myself_lay.addWidget(self.l_email, 7, 2, 1, 1)
        self.myself_lay.addWidget(self.d_email, 7, 3, 1, 3)
        self.myself_lay.addWidget(self.bt_update, 8, 5, 1, 2)
